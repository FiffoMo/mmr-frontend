      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-400">
            ...
            <li><NuxtLink to="/tarifs" class="hover:text-white">Tarifs</NuxtLink></li>
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-400">
            ...
            <li><NuxtLink to="/legal/confidentialite" class="hover:text-white">Politique de confidentialité</NuxtLink></li>
